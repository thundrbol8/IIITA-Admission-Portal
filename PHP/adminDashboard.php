            ...
            <div class="row" id="menuSection">
                ...
                <div class="col-md-2" style="background-color:#002147;">
                    ...
                    <div class="row justify-content-around pb-3">
                        <button class="btn btn-outline-info mb-3" id="viewProfile"><span class="fa fa-clock-o pr-3"></span><b>VIEW THE PROFILE</b></button>
                    </div>
                    <div class="row justify-content-around pb-3">
                        <a href="/UAS/PHP/viewApplicants.php"><button class="btn btn-outline-info" id="viewApplicants"><b><span class="fa fa-user pr-3"></span>VIEW APPLICANTS</b></button></a>
                    </div>
                    <div class="row justify-content-around py-3">
                        <a href="/UAS/PHP/programmes.php"><button class="btn btn-outline-info" name="interviewInfo"><b><span class="fa fa-calculator pr-3"></span>SEE PROGRAMME</b></button></a>
                    </div>
                    <div class="row justify-content-around py-3">
                ...
                <div class="col-md-10">
                    <div class="row justify-content-around py-4" style="background-color:#002147;">
                        ...
                        <div class="col-6 text-right px-5">
                            <h4 style="font-weight:600;">Admin ID: 
